...
;Example 2	
	...
	;ldx #69 				;Load x with Decimal 69
	;ldy 69					;Load y from memory address 0069 Decimal
	;ldy #%00101111			;Load y with 00101111 Binary also overwrite the value
	;ldy #4A00				;Load y with the content 4A00 hex memory adress
	;jsr monitor				;Show the monitor
	;jmp *					;Infinite Loop

	
;Example 3
	;lda #$15				;Set A to 15 Hexa
	;jsr monitor			;Show the monitor
...
;Example 4
	...
	;tax					;Transfer A to X
	;tya					;Transfer Y to A
	;; tyx/txy error. x, y can't communicate directly Have to done through accumulator
	;jsr monitor			;Show the monitor
	;jmp *					;Infinite Loop
